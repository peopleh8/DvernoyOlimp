...
const CategoryBlock = ({ className }) => {
  let prefix = useContext(PrefixContext)

  return (
    <div className={`main-intro__catalog-wrapper ${className}`}>
      <div className="main-intro__catalog">
        <div className="main-intro__catalog-list">
          <div className="main-intro__catalog-list-item">
            <Link className="main-intro__catalog-item-link" activeClassName="active" to={`${prefix}product-category/`}>
              ...
              <div className="main-intro__catalog-dropdown-item">
                ...
                <div className="main-intro__catalog-dropdown-list">
                  <div className="main-intro__catalog-dropdown-list-item">
                    <Link className="main-intro__catalog-dropdown-list-link" to={`${prefix}product-category/`}>Входные двери в Киеве</Link>
                  </div>
                  <div className="main-intro__catalog-dropdown-list-item">
                    <Link className="main-intro__catalog-dropdown-list-link" to={`${prefix}product-category/`}>Входные двери в Киеве</Link>
                  </div>
